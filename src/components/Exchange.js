...
const Exchange = () => {
  return (
    <div className="border-2 p-2 ml-4 w-full rounded-lg ">
      <div id="exchange">Exchange Coins</div>
      <div id="container" className="flex items-center">
        ...
        <div>
          ...
          >
            <option value="coin-sell" className="hover:bg-gray-100 hello rounded-lg">
              Etherium
            </option>
      ...
      <div id="container" className="flex items-center mt-2">
        <div id="sell">Buy</div>
        <div>
        <div className="flex items-center ml-8">
          ...
          <select
            ...
            className="border-none w-fit h-10  text-sm font-semibold rounded-md bg-gray-200"
          >
            <option value="Bitcoin" className="hover:bg-gray-100 hello rounded-md">
              Bitcoin
            </option>
